...
ApplicationWindow {
    ...
    property string swVersion: "1.0.2"
    property int pointSize:10
    property bool ledImgClicked: false
    ...
    header: ToolBar {
        ...
        RowLayout {
            ...
            ToolButton {
                ...
                Image {
                    source: "qrc:/qml/content/Risorse/setUp.png"
    ...
    Rectangle {
        ...
        Rectangle {
            id: scrollAreaRect
            width: parent.width // 700
            // anchors.margins: 10 // debuig line
            anchors.top: listRect.bottom
            // height: parent.height -  mainCmdtoolBar.height - dataTitleRow.height - footerRect.height -10// Constants.height
            height: parent.height -  listRect.height
            color:   "white" // "#c2c2c2";
            // border.width:  4
            // border.color: "gray"  // debug line
    ...
    //                                                                                    'DHCP unknown'
                                ...
                                Rectangle {
                                    ...
                                    RowLayout{
                                        ...
                                        Image {
                                            id: webImageId
                                            source: "qrc:/qml/content/Risorse/world.png"   //"web"
                                            fillMode: Image.PreserveAspectFit // For not stretching image (optional)
                                            smooth: true
                                            ...
                                            MouseDC{
                                                anchors.fill: parent
                                                privRightClick: openBrowser
                                                privLeftClick: openBrowser
                                                privGenClick: genericClick
                                                privIndex: index
                                                onClicked: {
                                                    console.log ("webImageId clicked")
                                                    scrollingListView.currentIndex = index
                                                }
                                            } // end MouseDC
                                        ...
                                        Image {
                                            id: ledImageId
                                            source: "qrc:/qml/content/Risorse/led.png"  // "jfif"
                                            fillMode: Image.PreserveAspectFit // For not stretching image (optional)
                                            smooth: true
                                            Layout.alignment: Qt.AlignRight
                                            Layout.minimumWidth: 25
                                            ...
                                            MouseDC{
                                                ...
                                                privRightClick: null
                                                privLeftClick: null
                                                privGenClick: null // genericClick
                                                privIndex: index
                                                onClicked: {
                                                    console.log ("ledImageId clicked")
                                                    scrollingListView.currentIndex = index
                                                }
                                            } // end MouseDC
    ...
    */
    ...
    function openBrowser(_param){
        var _index = scrollingListView.currentIndex
        var webIpAddrSet = (tp_view_object_helper_prop !== null) ?
                    tp_view_object_helper_prop.getIpAddr(_index): "0.0.0.0";
        var link = "http://"+webIpAddrSet
